...
class Firework:
    ...
    def __init__(self, x=None, y=None, firework_color=None, sound=None):
        self.x = x
        self.y = y
        self.firework_color = color(255) if firework_color is None else firework_color
        self.sound = sound
        ...
        for _ in range( self.particles_per_firework ):
            particle = Particle(self.x, self.y, self.firework_color)
